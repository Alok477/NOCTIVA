...
export default function HomePage() {
  ...
  return (
    ...
    >
      <SEO
        title="NOCTIVA — Discover Movies & TV Shows"
        description="Discover trending movies and TV shows, find new favorites, explore by genre, and track what you watch on NOCTIVA."
        noSuffix
      />
      
      {/* ── Visually Hidden H1 for SEO ── */}
      <h1 className="sr-only">NOCTIVA - Movie and TV Discovery, Matching, and Tracking</h1>
