  ...
  return (
    <div className="flex flex-col min-h-screen">
      <SEO
        ...
        description={
          genre
            ? `Discover ${genre.name.toLowerCase()} TV shows on NOCTIVA, from binge-worthy dramas to new favorites.`
            : 'Discover trending, top-rated, and new TV shows across every genre on NOCTIVA.'
        }
        url={`${import.meta.env.VITE_SITE_URL || window.location.origin}${buildBrowsePath('tv', genreId)}`}
      />
