...
function WatchlistPage() {
  ...
  return (
    ...
    >
      <SEO title="My Watchlist - NOCTIVA" description="View your saved movies and TV shows." />
            ...
            {items.map((item, index) => (
              ...
              >
                <ContentCard
                  ...
                  onClick={() => {
                    navigate(toDetailPath(item.type === 'tv' ? 'tv' : 'movie', item.mediaId, item.title), { state: { from: '/watchlist' } });
                  }}
