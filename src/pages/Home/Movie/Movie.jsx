  ...
  return (
    <div className="flex flex-col min-h-screen">
      <SEO
        ...
        description={
          genre
            ? `Discover ${genre.name.toLowerCase()} movies on NOCTIVA, from classics to new releases, and find your next favorite.`
            : 'Discover trending, top-rated, and new movies across every genre on NOCTIVA.'
        }
        url={`${import.meta.env.VITE_SITE_URL || window.location.origin}${buildBrowsePath('movie', genreId)}`}
      />
      ...
      <div className="sticky top-0 z-40 backdrop-blur-md bg-[#0b0f18]/80 border-b border-white/[0.06]">
          ...
          {genreId && (
            <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
              ...
              <select
                ...
                className="max-w-[42vw] bg-white/[0.07] border border-white/10 text-xs sm:text-sm text-gray-300 rounded-xl px-2 sm:px-3 py-2 focus:outline-none focus:ring-1 focus:ring-red-500 cursor-pointer"
              >
        ...
        {/* Mobile genre chips */}
        <div className="md:hidden mt-3 -mx-4 px-4 pb-1">
