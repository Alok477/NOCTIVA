...
const SITE_NAME = 'NOCTIVA';
const SITE_URL  = import.meta.env.VITE_SITE_URL || 'http://localhost:5173';
const DEFAULT_IMAGE = `${SITE_URL}/noctiva2.png`;

/**
 * Reusable SEO component.
 *
 * Props:
 *  title        – page title (appended with " | NOCTIVA" unless noSuffix)
...
export default function SEO({
  ...
  const fullTitle = title
    ...
    : `${SITE_NAME} — Movie Matcher & Tracker`;

  const metaDescription =
    description ||
    'Discover movies and TV shows, find personalized matches, track your viewing history, and save favorites — powered by TMDB.';
